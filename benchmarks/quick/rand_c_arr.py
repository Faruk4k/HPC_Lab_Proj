...
parser.add_argument('-l','--len', default=131072, type=int, help='Size of Random Array')
parser.add_argument('-r','--range', default=100000 , type=int, help='Upper Bound on Random Value -- 2 for Binary')
