...
ROOTS = [
    ("results_ampm_multisim_stage1", "stage1"),
    ("results_ampm_multisim_stage2", "stage2"),
]

OUT = "ampm_results.csv"
...
for ROOT, stage in ROOTS:
    ...
    for run_name in sorted(os.listdir(ROOT)):
        ...
        # expected format:
        # benchmark_ampm_config_level_memory
        parts = run_name.split("_ampm_")
        if len(parts) != 2:
            continue
