...
from nextline_configs import make_nextline_prefetcher
...
def get_prefetchers(prefetcher_name, pf_level, nextline_config):
    l1d_pf = None
    l2_pf = None
    ...
    if prefetcher_name == "nextline":
        pf_cls = make_nextline_prefetcher(nextline_config)
    else:
...
parser.add_argument(
    "--nextline-config",
    default="deg4",
    help="Nextline config name from nextline_configs.py",
)
...
l1d_pf, l2_pf = get_prefetchers(
    ...
    nextline_config=args.nextline_config,
)
...
print(f"Nextline config : {args.nextline_config}")
print("================================")
